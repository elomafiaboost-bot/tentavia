...
$compileCmd = "cl.exe src/main.cpp src/renderer/renderer.cpp src/menu/menu.cpp src/sdk/minecraft.cpp /LD /Ox /EHsc /std:c++17 /I src /Febuild/tentavia.dll /Fobuild/ user32.lib psapi.lib opengl32.lib gdi32.lib"
