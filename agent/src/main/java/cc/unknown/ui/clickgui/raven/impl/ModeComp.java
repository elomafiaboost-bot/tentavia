...
extends Component {
    ...
    public void renderComponent() {
        ...
        int bruhWidth = (int)((double)ModeComp.mc.field_71466_p.func_78256_a(this.mode.getName() + ": ") * 0.5);
        ModeComp.mc.field_71466_p.func_175065_a(this.mode.getName() + ": ", (float)((this.module.category.getX() + 4) * 2), (float)((this.module.category.getY() + this.o + 4) * 2), -1, true);
        ModeComp.mc.field_71466_p.func_175065_a(String.valueOf(this.mode.getMode()), (float)((this.module.category.getX() + 4 + bruhWidth) * 2), (float)((this.module.category.getY() + this.o + 4) * 2), this.c, true);
        GL11.glPopMatrix();
    }
