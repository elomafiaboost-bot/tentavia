...
public class HiddenUtil {
    public static void setVisible(boolean visible) {
        if (Haru.instance.getModuleManager() != null) {
            List<Class> modules = Arrays.asList(Tweaks.class, Ambience.class, ClickGuiModule.class, Fullbright.class, HUD.class, Nametags.class, CpsDisplay.class, ESP.class, FreeLook.class, Fullbright.class, Nametags.class, TargetHUD.class, Trajectories.class, Sprint.class, AutoLeave.class, Autoplay.class, Inventory.class, Keystrokes.class, MidClick.class);
